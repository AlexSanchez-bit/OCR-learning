...
from visualizations.real_time_train_visualization import RealTimeDataObserver
...
checkpoint_manager = WeightedCheckpointSaver(0.3,0.7,MODEL_STATE_PATH)
...
t=threading.Thread(target=trainer.train,args=[10,send_data])
t.start()
